    ...
    def details_selector(self) -> dict:
        ...
        net_utils.dict_merge(
            selector,
            {
                ...
                "details": {
                    "downloaded": {"regex": "arrow_downward([\\d.]+ ?[ZEPTGMK]?i?B)"},
                    "uploaded": {"regex": "arrow_upward([\\d.]+ ?[ZEPTGMK]?i?B)"},
                    "share_ratio": None,
                    "points": {"regex": "(\\d+)(Bonus|魅力值)"},
                    "seeding": {"regex": "play_arrow(\\d+)"},
                    "leeching": {"regex": "play_arrow\\d+/(\\d+)"},
                    "hr": None,
                },
            },
        )
